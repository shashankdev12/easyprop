...
module.exports = function(Countries)
{
  ...
  Countries.addCountries = function(req, cb)
  {
    let StateModel = app.models.states
    let x=0;
    let countries = [
    {
        "id": 1,
    ...
    async.eachOf(countries, function(cnt, cback)
    {

      StateModel.create({country_id:cnt.country_id,name:cnt.name,status:1,created:new Date()
  ...
  Countries.getCountries = function(req, cb)
  {
